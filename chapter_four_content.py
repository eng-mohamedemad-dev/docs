...
CHAPTER_FOUR_FIGURES = [
    ...
    ("Figure 4.2", "CrimeLens design blueprint and viewpoint map", 122),
    ("Figure 4.3", "High-level deployment context", 124),
    ("Figure 4.4", "Layered request and service model", 125),
    ("Figure 4.5", "Modular-monolith dependency diagram", 126),
    ("Figure 4.6", "Administrative console design map", 128),
    ("Figure 4.7", "Police-station operational design map", 129),
    ("Figure 4.8", "Camera, gateway, and media design map", 130),
    ("Figure 4.9", "AI integration and secured intake design", 131),
    ("Figure 4.10", "ERD split map by bounded context", 134),
    ("Figure 4.11", "ERD — incident, dispatch, and crime response", 135),
    ("Figure 4.12", "ERD — cameras, gateway, and AI detection", 136),
    ("Figure 4.13", "ERD — officers, shifts, patrol, and field safety", 137),
    ("Figure 4.14", "ERD — users, authentication, roles, and administration", 138),
    ("Figure 4.15", "ERD — communication, evidence, audit, and configuration", 139),
    ("Figure 4.16", "Security architecture and trust boundaries", 142),
    ("Figure 4.17", "Realtime channels, push notifications, and presence design", 145),
    ("Figure 4.18", "Web and mobile information architecture", 147),
    ("Figure 4.19", "Queue, scheduling, and worker design", 149),
    ("Figure 4.20", "Evidence storage and signed-media delivery design", 150),
    ("Figure 4.21", "Design-quality and trade-off summary map", 152),
]
    ...
    return [
        {
            ...
            "figure": figure(
                "Figure 4.2",
                "CrimeLens design blueprint and viewpoint map",
                "CH04_FIG_02_Design_Blueprint_Viewpoints.png",
                5.2,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_03_High_Level_Deployment_Context.png",
                6.2,
            ),
        },
        {
            ...
            "figure": figure(
                "Figure 4.4",
                "Layered request and service model",
                "CH04_FIG_04_Layered_Request_Service_Model.png",
                5.5,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_05_Modular_Monolith_Dependency_Diagram.png",
                5.7,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                "Figure 4.6",
                "Administrative console design map",
                "CH04_FIG_06_Administrative_Console_Design_Map.png",
                6.2,
            ),
        },
        {
            ...
            "figure": figure(
                "Figure 4.7",
                "Police-station operational design map",
                "CH04_FIG_07_Police_Station_Operational_Design_Map.png",
                6.3,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_08_Camera_Gateway_Media_Design_Map.png",
                6.5,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_09_AI_Integration_Secured_Intake_Design.png",
                6.4,
            ),
        },
        {
        ...
        },
        {
            ...
            "table": table(
                ...
                [
                    ["Figure 4.11", "Incident, dispatch, and crime response", "incidents, crimes, crime_types, incident_links, pattern_alerts"],
                    ["Figure 4.12", "Cameras, gateway, and AI detection", "cameras, ai_models, camera_ai_model, camera_detection_filters, ai_detection_logs, camera_tamper_events"],
                    ["Figure 4.13", "Officers and field operations", "officers, officer_shifts, officer_status_logs, officer_activity_logs, panic_events, bolos"],
                    ["Figure 4.14", "Users, authentication, roles, and administration", "admins, police_stations, station_users, permission tables, personal_access_tokens, admin_station"],
                    ["Figure 4.15", "Communication, evidence, audit, and configuration", "scenses, body_cam_uploads, chat_messages, notifications, firebase_tokens, ledger_entries, activity_logs, settings"],
                ],
                [3.2, 5.2, 7.8],
                accent=GOLD,
            ),
            "figure": figure(
                ...
                "CH04_FIG_10_ERD_Split_Map_By_Bounded_Context.png",
                6.0,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_11_ERD_Incident_Dispatch_Crime_Response.png",
                6.6,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_12_ERD_Cameras_Gateway_AI_Detection.png",
                6.6,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_13_ERD_Officers_Shifts_Patrol_Field_Safety.png",
                6.6,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_14_ERD_Users_Authentication_Roles_Administration.png",
                6.6,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_15_ERD_Communication_Evidence_Audit_Configuration.png",
                6.5,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_16_Security_Architecture_Trust_Boundaries.png",
                6.5,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                "Figure 4.17",
                "Realtime channels, push notifications, and presence design",
                "CH04_FIG_17_Realtime_Channels_Push_Presence_Design.png",
                6.3,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_18_Web_Mobile_Information_Architecture.png",
                6.0,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_19_Queue_Scheduling_Worker_Design.png",
                6.0,
            ),
        },
        {
            ...
            "figure": figure(
                ...
                "CH04_FIG_20_Evidence_Storage_Signed_Media_Delivery.png",
                6.1,
            ),
        },
        {
        ...
        },
        {
            ...
            "table": table(
                ...
                [
                    ...
                    ["ERD supports workflows", "Incident, Crime, Camera, Officer, Evidence, Audit entities connect correctly", "Figures 4.11 to 4.15"],
            ...
            "figure": figure(
                "Figure 4.21",
                "Design-quality and trade-off summary map",
                "CH04_FIG_21_Design_Quality_Tradeoff_Summary_Map.png",
                5.9,
            ),
            "info": (
                "Chapter close",
