...
CHAPTER_FIVE_FIGURES = [
    ...
    ("Figure 5.2", "Repository and module structure", 157),
    ("Figure 5.3", "Laravel modular-monolith implementation map", 159),
    ("Figure 5.4", "Admin console implementation surface", 164),
    ("Figure 5.5", "Dispatcher console implementation surface", 166),
    ("Figure 5.6", "Incident service transaction flow", 167),
    ("Figure 5.7", "Officer mobile implementation architecture", 170),
    ("Figure 5.8", "AI model service runtime lifecycle", 173),
    ("Figure 5.9", "Camera gateway runtime and stream fan-out", 175),
    ("Figure 5.10", "Security implementation layers", 181),
]
...
def chapter_five_page_specs() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_02_Repository_Module_Structure.png",
                6.2,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_03_Laravel_Modular_Monolith_Implementation_Map.png",
                6.0,
            ),
        },
        {
    ...
    setup({ el, App, props }) {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_04_Admin_Console_Implementation_Surface.png",
                6.2,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_05_Dispatcher_Console_Implementation_Surface.png",
                6.2,
            ),
        },
        {
    ...
    return $crime;
            ...
            "figure": figure(
                ...
                "CH05_FIG_06_Incident_Service_Transaction_Flow.png",
                6.2,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_07_Officer_Mobile_Implementation_Architecture.png",
                6.2,
            ),
        },
        {
...
final token = await authTokenStorage.readToken();""",
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_08_AI_Model_Service_Runtime_Lifecycle.png",
                6.2,
            ),
        },
        {
...
return $client->withHeader('X-Gateway-Token', $secret);""",
            ...
            "figure": figure(
                ...
                "CH05_FIG_09_Camera_Gateway_Runtime_Stream_Fanout.png",
                6.2,
            ),
        },
        {
        ...
        },
        {
            ...
            "figure": figure(
                ...
                "CH05_FIG_10_Security_Implementation_Layers.png",
                5.8,
            ),
        },
        {
